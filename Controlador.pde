class Controlador {
  ...
  Controlador(PApplet musica) {
    ...
    pantalla = 9;
    boton1 = new Boton(null, textos.getTextoParaPantallaBoton(pantalla, 0), resize.valorX(100), resize.valorY(490), 6);
    ...
    pantalla = 8;
    boton1 = new Boton(null, textos.getTextoParaPantallaBoton(pantalla, 0), resize.valorX(100), resize.valorY(490), 0);
    pantallas[pantalla] = new Pantalla(fondos[pantalla], textos.getTextoParaPantalla(pantalla), boton1, null, null, null);
