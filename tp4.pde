...
void draw() {
  ...
  if (pantalla==1 || pantalla==4 || pantalla==7 || pantalla ==11) {
    dibujarBotones (porcentajeX(width-700), porcentajeY(height-110), porcentajeX(145), porcentajeY(60));
    dibujarBotones (porcentajeX(width-245), porcentajeY(height-110), porcentajeX(145), porcentajeY(60));
